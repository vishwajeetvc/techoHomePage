  ...
  return (
    <div className="bg-white p-5 rounded-xl w-[300px] shrink-0">
      ...
      <div text className="">
        ...
        <p className="font-bold py-[10px] relative">{mainHeading}
          <div className="inline-block absolute right-1 top-3 w-[20px]">
            <img src={`${arrow}`} />
          </div>
        </p>
  ...
  return (
    <div className="py-[100px] flex justify-center bg-[#F8FAFC] ">
      <div className="w-5/6">
        ...
        <div cont className="py-[50px] flex  flex-col items-center  flex-nowrap gap-10 md:flex-row overflow-scroll overflow-y-hidden [&::-webkit-scrollbar]:hidden ">
          <Card
            img={`${course}`}
            heading={`Design`}
